      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-2 bg-[var(--gold)] px-8 py-3.5 text-xs tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[var(--gold-hover)]"
          >
        ...
        <div className="mt-16 border border-[var(--gold)]/30 bg-[#0e0c08] p-8 text-center sm:p-12">
          <p className="text-[10px] tracking-[0.35em] text-[var(--gold)] uppercase">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-8 inline-flex items-center gap-2 border border-white/30 px-8 py-3.5 text-xs tracking-[0.2em] text-white uppercase transition-colors duration-200 hover:border-[var(--gold)] hover:text-[var(--gold)]"
          >
