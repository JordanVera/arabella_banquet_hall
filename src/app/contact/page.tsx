...
export const metadata: Metadata = {
  ...
  description:
    'Tour Arabella Banquet Hall or inquire about booking a wedding, quinceañera, corporate event, or private celebration in Houston, TX.',
};
    ...
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        <Image
          ...
          alt="Visit Arabella Banquet Hall in Houston"
          fill
          priority
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-20">
          <p className="text-[var(--gold)] text-[10px] tracking-[0.4em] uppercase mb-4">
            Get in Touch
          </p>
        ...
        <div className="grid lg:grid-cols-[1fr_1.5fr] gap-16">
          <div className="flex flex-col gap-10">
            ...
            <ul className="flex flex-col gap-6">
              <li>
                ...
                >
                  <div className="w-10 h-10 border border-[var(--gold)]/30 flex items-center justify-center flex-shrink-0 group-hover:border-[var(--gold)] transition-colors">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 border border-border hover:border-[var(--gold)]/50 text-foreground/60 hover:text-[var(--gold)] text-xs tracking-wide transition-all"
                >
                  <Camera size={13} />
                  Instagram
                </a>
          ...
          <div className="bg-card border border-border p-8 md:p-10">
            ...
            <p className="text-foreground/50 text-sm mb-8">
              ...
              dates, guest count, and a tour of the hall.
            </p>
            <InquiryForm />
          </div>
        </div>
