    ...
    >
      ...
      >
        ...
        >
          <Link
            href="/contact"
            className="bg-[var(--gold)] px-8 py-3.5 text-xs font-medium tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[var(--gold-hover)]"
          >
            Get in Touch
          </Link>
          <Link
            href="/portfolio"
            className="border border-white/50 px-8 py-3.5 text-xs tracking-[0.2em] text-white uppercase transition-all duration-200 hover:border-[var(--gold)] hover:text-[var(--gold)]"
          >
            View Portfolio
          </Link>
        </motion.div>
